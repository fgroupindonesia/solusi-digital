...
-- Dumping data for table db_fgi_sistem_solusi_digital_v1.table_cs_wa_chat_rotator: ~3 rows (approximately)
...
-- Dumping data for table db_fgi_sistem_solusi_digital_v1.table_deposits: ~15 rows (approximately)
...
-- Dumping data for table db_fgi_sistem_solusi_digital_v1.table_order_jasa: ~15 rows (approximately)
...
INSERT INTO `table_order_jasa` (`id`, `order_id`, `order_client_reff`, `order_type`, `status`, `username`, `date_created`) VALUES
	...
	(57, 23, 'bhptbr', 'wa_chat_rotator', 'pending', 'udin', '2025-04-25 20:42:14'),
...
DROP TABLE IF EXISTS `table_order_landingpage`;
...
-- Dumping data for table db_fgi_sistem_solusi_digital_v1.table_order_wa_chat_rotator: ~14 rows (approximately)
...
DROP TABLE IF EXISTS `table_purchased_order`;
...
-- Dumping data for table db_fgi_sistem_solusi_digital_v1.table_purchased_order: ~2 rows (approximately)
...
DROP TABLE IF EXISTS `table_system_works`;
...
DROP TABLE IF EXISTS `table_themes_landingpage`;
...
DROP TABLE IF EXISTS `table_uploads_landingpage`;
...
INSERT INTO `table_users` (`id`, `username`, `pass`, `fullname`, `sex`, `occupation`, `email`, `propic`, `role`, `whatsapp`, `balance`, `points`, `date_created`) VALUES
	...
	(19, 'aziz', 'aziz', 'asd', 'male', '', 'aziz@gmail.com', 'default-male.png', 'admin', '123', 0, NULL, '2024-10-01 04:06:01'),
	(20, 'aziz', 'gugum', 'Gumuruh', 'male', NULL, 'fgroupindonesia@gmail.com', 'default-male.png', 'admin', '09123', 0, NULL, '2024-10-01 04:06:38'),
	(21, 'udin', 'udin', 'udin markopolo', 'male', NULL, 'udin@home.com', 'default-male.png', 'client', '123', 50000, NULL, '2024-10-01 04:07:51'),
...
-- Dumping data for table db_fgi_sistem_solusi_digital_v1.table_web_wa_chat_rotator: ~3 rows (approximately)
