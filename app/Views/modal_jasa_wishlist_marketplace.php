...
<div class="form-group row">
 ...
 <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="jasa-wishlist-marketplace-shopname" placeholder="ketik nama toko anda" name="shop_name" type="text" value="" class="form-control">
    </div>
  </div>
 ...
 <div class="form-group row">
    ...
    <div class="col-8">
      <div class="custom-control custom-radio custom-control-inline">
        <input name="package" id="jasa-wishlist-marketplace-paket-hemat" type="radio" class="custom-control-input" value="hemat"> 
