          ...
          <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; background-color: #ffffff; border-radius: 6px; overflow: hidden; font-family: Arial, sans-serif;">
            ...
            <tr>
              <td align="center" style="padding: 30px 30px 10px 30px;">
                <h1 style="margin: 0; font-size: 24px; color: #333;">🎉 Selamat Datang!</h1>
              </td>
            </tr>
            ...
            <tr>
              <td style="padding: 10px 30px 30px 30px; color: #555; font-size: 16px; line-height: 1.5;">
                ...
                <p style="margin: 0 0 10px 0;">
                  Terimakasih sudah mendaftar di platform online : <strong>Solusi Digital</strong>. <br>
                  Dan kabar baiknya yaitu...
                </p>
                <p style="margin: 0 0 10px 0;">
                  Kamu bisa langsung login menggunakan cridential ini<br> <b>username : <?= $username; ?></b>, dan <b>password : <?= $pass; ?></b> <br> segera lho!
                </p>
              </td>
            </tr>
            ...
            <tr>
              <td align="center" style="padding: 0 30px 40px 30px;">
                <a href="<?= $login_url; ?>" style="background-color: #0d6efd; color: #ffffff; text-decoration: none; padding: 12px 25px; font-size: 16px; border-radius: 4px; display: inline-block;">Login Sekarang</a>
              </td>
            </tr>
