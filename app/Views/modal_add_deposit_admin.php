...
<div class="form-group row">
 ...
 <div class="form-group row">
    ...
    <div class="col-8">
      <div class="custom-control custom-radio custom-control-inline">
        <input name="amount" id="add-deposit-admin-50" type="radio" class="custom-control-input" value="50"> 
        <label for="add-deposit-admin-50" class="custom-control-label">50rb</label>
      </div>
      <div class="custom-control custom-radio custom-control-inline">
        <input name="amount" id="add-deposit-admin-100" type="radio" class="custom-control-input" value="100"> 
        <label for="add-deposit-admin-100" class="custom-control-label">100rb</label>
      </div>
    <div class="custom-control custom-radio custom-control-inline">
        <input name="amount" id="add-deposit-admin-200" type="radio" class="custom-control-input" value="200"> 
        <label for="add-deposit-admin-200" class="custom-control-label">200rb</label>
      </div>
    <div class="custom-control custom-radio custom-control-inline">
        <input name="amount" id="add-deposit-admin-500" type="radio" class="custom-control-input" value="500"> 
        <label for="add-deposit-admin-500" class="custom-control-label">500rb</label>
      </div>
    <div class="custom-control custom-radio custom-control-inline">
        <input name="amount" id="add-deposit-admin-1000" type="radio" class="custom-control-input" value="1000"> 
