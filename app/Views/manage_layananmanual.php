...
<head>
    ...
    <title>Manage Layanan Manual - Solusi Digital</title>
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Management Layanan Manual</h4>
                    </div>
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="white-box">
                            <div class="d-md-flex mb-3">
                                <h3 class="box-title mb-0">All Layanan Manual (<?= $total_layananmanual ?>)</h3><br>
                                   <img id="management-loading" src="/assets/plugins/images/loading.gif" >
                                <div class="col-md-4 col-sm-4 col-xs-6 ms-auto">
                                  <a data-bs-toggle="modal" data-bs-target="#layananmanual-form-modal" class="link-add" id="link-add" href="/add-new-layananmanual">Add New</a>
                                    <a class="link-edit" href="/edit-layananmanual" data-entity='layananmanual'>Edit</a>
                                    <a class="link-delete" href="/delete-layananmanual" data-entity='layananmanual'>Delete</a>
                                   
                                </div>
                            </div>
                            <div class="table-responsive">
                                <table id="table-layananmanual" class="table no-wrap">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                   <?php if (isset($data_layananmanual)): ?>                 
                  <?php foreach($data_layananmanual as $key): ?>

                        
                                        <tr>
                                            <td><input type="checkbox" class="user-checked" data-id="<?= $key->id ?>" /></td>
                                            <td class="txt-oflo"> <?= $key->username_owned ?></td>
                                            <td><?= $key->jenis_layanan ?>
                                            </td>
                                            <td class="txt-oflo"><?= $key->quantity ?></td>
                                              <td class="txt-oflo"><?= $key->status ?></td>
                                            <td><span class="text-success"><?= $key->date_created ?></span></td>
                                            <td>
                    <a href="#" data-id="<?= $key->id ?>" class="cancel-layananmanual btn d-grid btn-warning text-white">
                                Cancel</a>
                                            </td>
                                        </tr>
