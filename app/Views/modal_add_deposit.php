<div class="modal fade" id="add-deposit-form-modal" tabindex="-1">
  <form id="add-deposit-form" action="/update-settings" method="post">
 ...
 <div class="form-group row">
    ...
    <div class="col-8">
      <div class="custom-control custom-radio custom-control-inline">
        <input name="saldo" id="add-deposit-50" type="radio" class="custom-control-input" value="50"> 
        <label for="add-deposit-50" class="custom-control-label">50rb</label>
      </div>
      <div class="custom-control custom-radio custom-control-inline">
        <input name="saldo" id="add-deposit-100" type="radio" class="custom-control-input" value="100"> 
        <label for="add-deposit-100" class="custom-control-label">100rb</label>
      </div>
    <div class="custom-control custom-radio custom-control-inline">
        <input name="saldo" id="add-deposit-200" type="radio" class="custom-control-input" value="200"> 
        <label for="add-deposit-200" class="custom-control-label">200rb</label>
      </div>
    <div class="custom-control custom-radio custom-control-inline">
        <input name="saldo" id="add-deposit-500" type="radio" class="custom-control-input" value="500"> 
        <label for="add-deposit-500" class="custom-control-label">500rb</label>
      </div>
    <div class="custom-control custom-radio custom-control-inline">
        <input name="saldo" id="add-deposit-1000" type="radio" class="custom-control-input" value="1000"> 
